...
app/                    --> all of the source files for the application
  ...
  admin/                --> the admin view template and logic
    admin.html            --> the partial template
    admin.js              --> the controller logic
    admin_test.js         --> tests of the controller
  district/                --> the district view template and logic
    district.html            --> the partial template
    district.js              --> the controller logic
    district_test.js         --> tests of the controller
